...
└── src                               # Source code directory.
    ...
    │   │   │   ├── __init__.py
    │   │   │   ├── crud_token_blocklist.py  # CRUD operations for token blocklist.
    │   │   │   ├── database.py       # Database connectivity and session management.
    │   │   │   ├── models.py         # Core Database models.
    │   │   │   └── token_blocklist.py  # Model for token blocklist functionality.
    │   │   │
...
#### 5.2.1 Token Blocklist

Note that this table is used to blocklist the `JWT` tokens (it's how you log a user out) <br>
